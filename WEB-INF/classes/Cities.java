...
public class Cities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Events> allcityevents = new HashMap<String,Events> ();
		
		allcityevents = MySqlDataStoreUtilities.getCityEvents(city);
		System.out.println(allcityevents);
		...
		pw.print("<a style='font-size: 24px;'>Games near You</a>");
		pw.print("</h2><div class='entry'><table  id='bestseller'>");
		int i = 1; int size= allcityevents.size();
		for(Map.Entry<String, Events> entry : allcityevents.entrySet())
		{
