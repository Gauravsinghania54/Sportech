...
public class data  {
    ...
    public static void doPost(String request,String response) 
             
     {
        ...
        try
        {
      String filePath="C:\\Illinois tech\\EWA\\apache-tomcat-7.0.34\\webapps\\Sportech\\WEB-INF\\classes\\"+request+".json";
    ...
    public static Connection ConnectToDB() throws Exception {
      ...
      String mysqlUrl = "jdbc:mysql://localhost:3306/Sportech?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
